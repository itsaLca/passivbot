...
class Bybit(Bot):
    def __init__(self, config: dict):
        ...
        self.base_endpoint = "https://api-testnet.bybit.com"# "https://api.bybit.com"
        self.endpoints = {
    ...
    def init_market_type(self):
        if self.symbol.endswith("USDT"):
            ...
            self.endpoints = {
                ...
                "websocket_market": "wss://stream-testnet.bybit.com/realtime_public",
                "websocket_user": "wss://stream-testnet.bybit.com/realtime_private",
